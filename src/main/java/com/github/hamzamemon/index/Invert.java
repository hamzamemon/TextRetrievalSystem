...
public class Invert {
    ...
    public static final String TERMS = "src/main/resources/indexed/terms.ser";
    public static final String DOCS = "src/main/resources/indexed/docs.ser";
    public static final String LIST = "src/main/resources/indexed/list.ser";
    ...
    public static void main(String[] args) {
        ...
        termIndex.addDocuments(documentIndex, postingLists);
