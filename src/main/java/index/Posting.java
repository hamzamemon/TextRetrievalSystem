 ...
 * the frequency of said term in the file, the weight and the first location of the term in the
 * file.
 */
public class Posting implements Serializable {

  public static final Comparator<Posting> COMPARATOR = Comparator
          .comparing(posting -> posting.number);
  ...
  public String toString() {
    return "Posting{" + "number=" + number + ", frequency=" + frequency + ", weight=" + weight
            + '}';
  }
}
