...
public class Invert {
  ...
  public static void main(String... args) {
    ...
    PostingLists postingLists=new PostingLists();DocumentIndex documentIndex=new DocumentIndex();TermIndex termIndex=new TermIndex(documentIndex,postingLists);

    setDocLengths(termIndex,documentIndex,postingLists);writeObjects(termIndex,documentIndex,postingLists);

    long end=System.nanoTime();long diff=end-start;

    System.out.println("termIndex.size() = "+termIndex.size());System.out.println("diff = "+diff/1_000_000_000.0);
  }
   ...
   */
  private static void setDocLengths(TermIndex termIndex, DocumentIndex documentIndex,
  ...
  private static void writeObject(Object object, String filename) {
    try {
      ...
      ObjectOutputStream oos = new ObjectOutputStream(
              new FileOutputStream(randomAccessFile.getFD()));
