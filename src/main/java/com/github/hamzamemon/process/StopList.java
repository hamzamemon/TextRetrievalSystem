package com.github.hamzamemon.process;
...
/**
 * This class is a HashSet of the words contained in stoplist.txt. These words should not be
...
public final class StopList extends HashSet<String> {
    ...
    public StopList() {
        try (Scanner scanner = new Scanner(new File("src/main/java/process/stoplist.txt"))) {
            ...
            System.out.println("stoplist.txt could not be opened.");
        }
    }
